...
-- NOTA: La contraseña se almacena en texto plano inicialmente.
-- El sistema la hasheará automáticamente con BCrypt en el primer inicio de sesión exitoso.
-- Esto garantiza compatibilidad entre diferentes versiones de BCrypt.NET
...
BEGIN
    ...
    VALUES ('admin', 'admin', 'Administrador del Sistema', 'Administrador', 1);
END
GO
